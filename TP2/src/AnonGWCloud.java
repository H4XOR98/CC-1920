...
public class AnonGWCloud {
    ...
    public synchronized int insertClient(String clientAddress, WriterPermission writerPermission){
        int result = -1;
        if(!this.clients.containsKey(clientAddress)){
            this.clients.put(clientAddress,clientId);
            this.writerPermissions.put(clientId, writerPermission);
            result = clientId++;
    ...
    public synchronized void insertRequest(String clientAddress, byte[] request) {
        if (clientAddress != null && request != null && this.clients.containsKey(clientAddress)) {
            ...
            if(this.writerPermissions.containsKey(id)){
    ...
    public synchronized void insertReply(int id, byte[] content) {
        if(content != null && this.clients.containsValue(id) && !this.replys.containsKey(id) && this.writerPermissions.containsKey(id)){
